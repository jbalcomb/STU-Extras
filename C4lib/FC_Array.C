...
In-Place vs. Copy vs. Overlay

Overlay:
array of array indices to original array


Treat it like a Tree, Baby!
U-Nary
Bi-Nary
Tri-Nary
...
...
void sortset(int data_type, void const* array, uint64_t array_length, uint8_t** unique_array, uint64_t* unique_array_length)
{
	...
	switch (data_type)
	{
		case 0:
		{
			unique_array_uint8(array, array_length, unique_array, unique_array_length);
			Bubble_Sort_uint8(*unique_array, *unique_array_length);
		} break;
		case 1:
		{
			// unique_array_int8(array, array_length, unique_array, unique_array_length);
			// Bubble_Sort_int8(unique_array, unique_array_length);
		} break;
		case 2:
		{
			unique_array_uint16(array, array_length, unique_array, unique_array_length);
			Bubble_Sort_uint16(*unique_array, *unique_array_length);

		} break;
		case 3:
		{
			// unique_array_int16(array, array_length, unique_array, unique_array_length);
			// Bubble_Sort_int16(unique_array, unique_array_length);
		} break;
	}
...
/*
	unique_array_uint8(ut, NUM_UNIT_TYPES, &ut_set, &set_cnt);
	Bubble_Sort_uint8(ut_set, set_cnt);
*/
