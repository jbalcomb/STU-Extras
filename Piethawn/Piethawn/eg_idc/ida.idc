...
//
#include <idc.idc>
// #include <C:\STU_WD_IDA55\IDA55\idc\stu_del_loc.idc>
// #include <stu_del_loc.idc>
...
//
  ...
  // SetCharPrm(INF_LFLAGS, LFLG_DBG_NOPATH|GetCharPrm(INF_LFLAGS));
	...
	idchk = AddHotkey("z", "MyAmazingFunc"); //Now 'z' invokes MyAmazingFunc
	if(idchk != IDCHK_OK)
	{
		Message("FAILURE: AddHotkey() \n");
	}
