...
void    ChangeConfig(char directive);
...
#define BPTATTR_SIZE 4    // size of the breakpoint (undefined for software breakpoint)
...
#define BPTATTR_COUNT 12  // number of times the breakpoint is hit before stopping
