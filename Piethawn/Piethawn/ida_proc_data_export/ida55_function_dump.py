...
def parse_dump(path: Path) -> Dict[str, object]:
    ...
    for function in functions:
        ...
        if "has_user_color" in function:
            function["has_user_color"] = bool(int(function.get("has_user_color") or 0))
        if "item_color_hex" in function:
            function["is_default_color"] = str(function.get("item_color_hex", "")).upper() == "FFFFFFFF"
